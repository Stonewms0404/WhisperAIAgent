...
#
get_filename_component(filename "D:/Programming Projects/WhisperAIAgent/build/include/piper/f/src/10.0.0.zip" ABSOLUTE)
get_filename_component(directory "D:/Programming Projects/WhisperAIAgent/build/include/piper/f/src/fmt_external" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-fmt_external${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-fmt_external${i}")
